...
const initialWorkflow: WorkflowSettings = {
  ...
  mpZones: [
    { id: '1', name: 'Residential - Low Density', color: '#8BC34A', type: 'residential-low', selected: true, areaHa: 12.4 },
    { id: '2', name: 'Commercial', color: '#2196F3', type: 'commercial', selected: true, areaHa: 5.6 },
    { id: '3', name: 'Green Space', color: '#66BB6A', type: 'green', selected: true, areaHa: 6.2 },
  ],
  ...
  explodedComponents: [
    { id: '1', name: 'Foundation', title: 'Foundation', description: '', attributes: [], order: 0, active: true, category: 'structure' },
    { id: '2', name: 'Structure', title: 'Structure', description: '', attributes: [], order: 1, active: true, category: 'structure' },
    { id: '3', name: 'Floor Slabs', title: 'Floor Slabs', description: '', attributes: [], order: 2, active: true, category: 'structure' },
    { id: '4', name: 'Exterior Walls', title: 'Exterior Walls', description: '', attributes: [], order: 3, active: true, category: 'envelope' },
    { id: '5', name: 'Interior Walls', title: 'Interior Walls', description: '', attributes: [], order: 4, active: false, category: 'interior' },
    { id: '6', name: 'Roof', title: 'Roof', description: '', attributes: [], order: 5, active: true, category: 'structure' },
    { id: '7', name: 'Windows', title: 'Windows', description: '', attributes: [], order: 6, active: true, category: 'envelope' },
    { id: '8', name: 'MEP Systems', title: 'MEP Systems', description: '', attributes: [], order: 7, active: false, category: 'mep' },
  ],
