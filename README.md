...
- ChatGPT Images 2.5: OpenAI `gpt-image-2.5-sunburst` path for specific edits to existing or already rendered images, stronger preservation, controlled masks/selections, object/material changes, and text-heavy images.
