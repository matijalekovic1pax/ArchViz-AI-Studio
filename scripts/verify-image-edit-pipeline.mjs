...
function assertSourceContract() {
  ...
  assert.doesNotMatch(generationHookSource, /prepareVerification: createLocalizedVerificationPreparation/, 'image generation must not prepare output verification retries');
  assert.doesNotMatch(generationHookSource, /buildLocalizedEditProofMap/, 'localized edit proof maps were only used by the removed output verification layer');
